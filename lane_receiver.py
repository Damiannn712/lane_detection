...
# ==========================================
# Functiile auxiliare (Mutate in afara buclei)
# ==========================================
def fit_lane(xs, ys):
    if len(xs) < 2:
        return None
...
# ==========================================
# Initializare Conexiune si Variabile
# ==========================================
...
# ==========================================
# Bucla principala de receptie si procesare
# ==========================================
while True:
    # Primim (ret, frame) de la sender in loc de la cam.read()
    ret, frame = s.recv_object()

    if not ret:
        print("Procesare finalizata sau conexiune intrerupta.")
        break
    ...
    # Exercitiul 10 (Apelam functiile definite sus)
